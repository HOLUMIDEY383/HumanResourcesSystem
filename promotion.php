        ...
        <div class="page">
            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <div class="content-inner">
                    ...
                    <br><br>
                    <a href="#" class="btn btn-primary float-md-right" data-toggle="modal" id="URequest"data-target="#URequestPromotion">Request Promotion</a>
                    <br><br>
                    <section class="projects no-padding-top">
                        <div class="container-fluid">
                            ...
                            <div class="project">
                                <div class="card">
                                    <div class="card-body">
                                       <table class="table table-striped display col"style="width: 100%; table-layout: auto;" class="flexible generaltable generalbox" cellspacing="0"id="Ustaffpromotion">
                                            <thead>
                                                <tr>
                                                    <!--<th>S.N</th>-->
