                ...
                <div class="content-inner">
                    ...
                    <header class="page-header">
                        <div class="container-fluid">
                            <h3 class="no-margin-bottom"><a href="Dashboard.php">Dashboard</a>/Appraisal</h3>
                        </div>
                    </header>
                    <br><br>
                    ...
                    <section class="projects no-padding-top">
                        <div class="container-fluid">
                            ...
                            <div class="project">
                                <div class="card">
                                    <div class="card-body">
                                       <table class="table table-striped display col"style="width: 100%; table-layout: auto;" class="flexible generaltable generalbox" cellspacing="0" id="Stappraisal">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Employee</th>
