<?php
include 'Modals/Complain.php';
include 'Modals/staffmodal.php';
include 'Modals/Unit.php';
include 'Modals/Faculty.php';
include 'Modals/CompanyName.php';
include 'Modals/Eventmodal.php';
include 'Modals/Leave.php';
include 'Modals/contract.php';
include 'Modals/appraisal.php';
include 'Modals/permission.php';
include 'Modals/department.php';
...
<footer class="main-footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <p class="mb-2 mb-md-0">Your CUCG &copy; 2020-2021</p>
                <!--<p>Your company &copy; 2017-2020</p>-->
            </div>
            <div class="col-sm-6 text-right">
                <p class="mb-0">Design by <a href="https://bootstrapious.com/admin-templates" class="external text-gray-400">MDL</a></p>
...
<script src="vendor/dropzone/min/dropzone.min.js" type="text/javascript"></script>
...
<!--<script src="vendor/editor js/quill.min.js" type="text/javascript"></script>-->
...
<script src="js/vacancy.js" type="text/javascript"></script>
<script src="js/attendance.js" type="text/javascript"></script>
<script src="js/appraisal.js" type="text/javascript"></script>
<script src="js/permission.js" type="text/javascript"></script>
<script src="vendor/fileup/fileup.min.js" type="text/javascript"></script>
...
<script src="vendor/Bootbox/bootbox.locales.min.js" type="text/javascript"></script>
