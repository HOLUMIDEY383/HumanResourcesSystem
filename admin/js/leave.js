                ...
                columns: [
                    {
                        ...
                        render: function (data, type, row) {
                            return '<a href="#" class="leavedetails" id="' + row.id + '"  title="preview"><i class="fa fa-plus-circle "text-gray" style="font-size:25px;color:green;" ></i></a>';
                        }
                    },
                    {
                        data: 'data',
            ...
            $.post("Php/server.php", {
                ...
                if (data === "true") {
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: 'You have successful Request for a leave',
                        showConfirmButton: false
                    });
